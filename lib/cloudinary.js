...
export const LogoImage = cld
  ...
  .quality("auto")
  .format("auto");
export const GetflixImage = cld
  .image(
    "https://res.cloudinary.com/slapathabass/image/upload/a_90/v1654616576/Deloach-dev/Screen_Shot_2022-06-07_at_10.41.44_AM_aif2xg.png"
  )
  .quality("auto")
  .format("auto");
